 ...
 */
public class AllAuctionsAdapter extends ArrayAdapter<AuctionItem> {
    ...
    public AllAuctionsAdapter(Context context, int resource, ArrayList<AuctionItem> auctionItems) {
